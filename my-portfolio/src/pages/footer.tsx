...
export default function Footer() {
  return (
    <div className=" bg-[#D8DFE5] flex flex-col rounded-t-[100px] gap-3 justify-center items-center py-25 w-screen">
