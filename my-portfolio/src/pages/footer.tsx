...
export default function Footer() {
  return (
    <div className="bg-[rgba(216,223,229,1)] flex flex-col  rounded-[50px] xs:rounded-[60px] sm:rounded-[70px] md:rounded-[80px] lg:rounded-[90px] xl:rounded-[100px] gap-3 justify-center items-center py-25 w-screen">
